...
You can direct message it or call it using the name you gave it (@shopbot) and then say you want to shop. You will have to know what products you have loaded in your Discovery to know what to ask for, but then the bot will give you a list to choose from. Tell the bot you want to add an item by saying "add" and then the number of the item.
